            ...
            <div class="max-w-[1200px] mx-auto px-8">
                ...
                <div class="space-y-8">
                    <div class="bg-slate-900/50 border border-slate-800 rounded-xl p-8">
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-1">
                                <h3 class="text-2xl font-bold text-white mb-4">Install GitHub App</h3>
                    ...
                    <div class="bg-slate-900/50 border border-slate-800 rounded-xl p-8">
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-1">
                                <h3 class="text-2xl font-bold text-white mb-4">Deploy Kubernetes Controller</h3>
                                <p class="text-slate-300 mb-4 leading-relaxed">
                                ...
                                <div class="bg-slate-950 border border-slate-700 rounded-lg p-4 mb-4">
                                    ...
                                    <pre class="text-green-400 text-sm whitespace-pre-wrap"><code>helm repo add octopilot https://charts.octopilot.app
                                        helm repo update
                                        helm install secret-controller octopilot/secret-controller-manager \
                                        --namespace octopilot-system \
                                        --create-namespace \
                                        --set github.appId=YOUR_APP_ID \
                                        --set github.installationId=YOUR_INSTALLATION_ID</code></pre>
                                </div>
                                <div class="bg-slate-950 border border-slate-700 rounded-lg p-4">
                                    ...
                                    <pre class="text-green-400 text-sm whitespace-pre-wrap"><code>kubectl apply -f https://octopilot.app/install/latest.yaml</code></pre>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-slate-900/50 border border-slate-800 rounded-xl p-8">
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-1">
                                <h3 class="text-2xl font-bold text-white mb-4">Generate Repository Keys</h3>
                                <p class="text-slate-300 mb-4 leading-relaxed">
                    ...
                    <div class="bg-slate-900/50 border border-slate-800 rounded-xl p-8">
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-1">
                                <h3 class="text-2xl font-bold text-white mb-4">Encrypt Your First Secret</h3>
                                <p class="text-slate-300 mb-4 leading-relaxed">
                    ...
                    <div class="bg-slate-900/50 border border-slate-800 rounded-xl p-8">
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-1">
                                <h3 class="text-2xl font-bold text-white mb-4">Verify Decryption in Cluster</h3>
                                <p class="text-slate-300 mb-4 leading-relaxed">
                ...
                <div class="mt-8 bg-gradient-to-br from-green-950/20 to-slate-900/50 border border-green-900/30 rounded-xl p-8">
                    ...
                    <div class="flex items-center gap-4">
                        <button class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-semibold flex items-center gap-2">
                            <i class="fa-solid fa-code-branch"></i>
                            Set Up CI/CD Integration
                        </button>
                        <button class="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors font-semibold flex items-center gap-2">
                            <i class="fa-solid fa-users"></i>
                            Configure Multi-Team Policies
                        </button>
                        <button class="px-6 py-3 border border-slate-700 hover:border-slate-600 text-white rounded-lg transition-colors font-semibold flex items-center gap-2">
