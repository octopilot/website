...
const DocsHero: Component = () => {
    return (
        <section id="onramp-hero" class="min-h-[650px] relative overflow-hidden border-b border-slate-800/50 pt-20 pb-16 md:pb-0">
            ...
            <div class="max-w-[1200px] mx-auto px-8 h-full flex flex-col justify-center relative z-10">
                <div class="flex items-center gap-3 mb-6">
                    <span class="px-3 py-1 bg-blue-500/20 border border-blue-500/30 rounded-full text-blue-400 text-[10px] md:text-xs font-bold uppercase tracking-wider">
                        Onramp Hub
                    </span>
                    <span class="text-slate-500">•</span>
                    <span class="text-slate-400 text-xs md:text-sm">Get Started in Minutes</span>
                </div>
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4">
                    <button class="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:bg-gradient-to-l text-white rounded-lg transition-colors font-semibold flex items-center justify-center gap-2">
                        <i class="fa-solid fa-rocket"></i>
                        Deploy in Cluster
                    </button>
                    <button class="w-full sm:w-auto px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white rounded-lg transition-colors font-semibold flex items-center justify-center gap-2">
