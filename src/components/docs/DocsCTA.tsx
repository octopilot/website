    ...
    return (
        <section id="cta-deploy" class="py-16 border-b border-slate-800/50 bg-slate-900/20">
            <div class="max-w-[1200px] mx-auto px-8">
                <div class="bg-gradient-to-br from-indigo-950/50 to-slate-900 border border-indigo-900/50 rounded-2xl p-12 text-center relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        <div class="w-20 h-20 bg-indigo-500/20 rounded-full flex items-center justify-center mx-auto mb-6">
                            <i class="fa-solid fa-rocket text-indigo-400 text-3xl"></i>
                        </div>
                        ...
                        <div class="flex items-center justify-center gap-4 mb-6">
                            <button class="px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-lg transition-colors font-semibold text-lg flex items-center gap-2">
                                <i class="fa-solid fa-dharmachakra"></i>
                                Deploy in Cluster
                            </button>
                            <button class="px-8 py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors font-semibold text-lg flex items-center gap-2">
                                <i class="fa-solid fa-code-branch"></i>
                                Integrate with CI/CD
                            </button>
                            <button class="px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white rounded-lg transition-colors font-semibold text-lg flex items-center gap-2">
