...
const ArchitectureHero: Component = () => {
    return (
        <section id="architecture-hero-section" class="relative min-h-[650px] h-auto overflow-hidden border-b border-octo-border pt-24 lg:pt-20 pb-12 lg:pb-0">
            ...
            <div class="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-8 h-full flex items-center">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
                    <div class="max-w-2xl">
                        ...
                        <div class="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6 text-sm text-gray-400">
